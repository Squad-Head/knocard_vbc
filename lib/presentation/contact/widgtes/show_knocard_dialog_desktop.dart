...
import 'package:knocard_ui/presentation/contact/widgtes/text_input_box.dart';

class ShowKnocardDialogDesktop extends HookConsumerWidget {
  const ShowKnocardDialogDesktop({Key? key}) : super(key: key);
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.only(
                          topLeft: Radius.circular(2.5.sp),
                          topRight: Radius.circular(2.5.sp))),
                  child: Text(
                    'Share this KnoCard',
                    style: TextStyle(
                      fontSize: 14.sp,
